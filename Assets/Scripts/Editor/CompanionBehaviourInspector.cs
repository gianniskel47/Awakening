...
namespace BlazeAISpace
{
    ...
    public class CompanionBehaviourInspector : Editor
    {
        ...
        void DrawGeneralTab()
        {
            ...
            BlazeAIEditor.CheckDisableWithRootMotion(script.blaze, runSpeed);
            EditorGUILayout.Space();
            ...
            BlazeAIEditor.CheckDisableWithRootMotion(script.blaze, walkSpeed);
            EditorGUILayout.Space();
        ...
        void DrawWanderingTab(CompanionBehaviour script)
        {
            ...
            if (script.wanderAround) {
                ...
                BlazeAIEditor.CheckDisableWithRootMotion(script.blaze, wanderMoveSpeed);
                EditorGUILayout.Space(10);
                
                BlazeAIEditor.DrawMultiPopupProperty(script.blaze.anim, "Wander Idle Anims", "wanderIdleAnims", scripts);
                EditorGUILayout.Space();
